"""
Django settings for tokens_example project.
...
SECRET_KEY = 'django-insecure-2nerc^@1j8ij(6m_57e+&!x@k-m&ev=2ukmqfm#c1s2!49c!6x'
...
WSGI_APPLICATION = 'tokens_example.wsgi.application'
